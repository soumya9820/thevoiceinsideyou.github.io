...
scene.background = new THREE.CubeTextureLoader()
					.setPath( 'js/three.js-master/examples/textures/cube/SwedishRoyalCastle/' )
...
function createMaterials(){
     ...
     newStandard = new THREE.MeshStandardMaterial( {
          ...
          pointnewmaterial = new THREE.PointsMaterial( { color: 0x888888 } );
...
function loadModels() {
  ...
  const Position2 = new THREE.Vector3( 9, 0, -100 );
  loader.load( 'models/wonder_women.glb', gltf => onLoad( gltf, Position2, pointnewmaterial), onProgress, onError );
...
function render() {
  ...
  newStandard.displacementscale += 0.1;
